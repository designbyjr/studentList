    ...
    <div class="collapse navbar-collapse  w-auto h-auto max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4  ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Teachers</h6>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="https://github.com/creativetimofficial/ct-soft-ui-dashboard-pro/blob/main/CHANGELOG.md" target="_blank">
                    ...
                    <span class="nav-link-text ms-1">{{$teacher->title}} {{$teacher->forename}} {{$teacher->surname}}</span>
                </a>
            </li>
            @endforeach
        </ul>
        ...
        <div class="row mt-0 mb-4">
            <div class="col-12">
                <div class="card bg-gradient-secondary">
                    <img src="{{asset("/img/shapes/waves-white.svg")}}" alt="pattern-lines" class="position-absolute opacity-4 start-0 top-0 w-100">
                    <div class="card-body px-5 z-index-1 bg-cover">
                        <div class="row">
                            <div class="col-lg-3 col-12 my-auto">
                                <h4 class="text-white opacity-9">Since Last Login</h4>
                                <hr class="horizontal light mt-1 mb-3">
                                <div class="d-flex">
                                    <div>
                                        <h6 class="mb-0 text-white opacity-7">Behaviour incidents</h6>
                                        <h3 class="text-white">21 <small class="text-sm align-top">Students</small></h3>
                                    </div>
                                    <div class="ms-lg-6 ms-4">
                                        <h6 class="mb-0 text-white opacity-7">Avg Attendance</h6>
                                        <h3 class="text-white">89 <small class="text-sm align-top">%</small></h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="row mt-4">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="card" style="background-image: url('{{asset("/img/curved-images/white-curved.jpeg")}}')">
                                    ...
                                    <div class="card-body p-3 position-relative">
                                        <div class="row">
                                            <div class="col-8 text-start">
                                                ...
                                                <span class="text-white text-sm">Mr Christopher Hughes</span>
                                            </div>
                                            <div class="col-4">
                                                ...
                                                <p class="text-white text-sm text-end font-weight-bolder mt-auto mb-0">+15% Better Marks</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
